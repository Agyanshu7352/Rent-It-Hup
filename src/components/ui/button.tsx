  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-teal-400 text-primary-foreground shadow-glow hover:shadow-elevated hover:-translate-y-0.5 font-semibold",
        ...
        warm: "bg-gradient-to-r from-secondary to-amber-400 text-secondary-foreground shadow-soft hover:shadow-elevated hover:-translate-y-0.5 font-semibold",
        glass: "bg-white/10 backdrop-blur-xl border border-white/20 text-foreground hover:bg-white/20 shadow-soft",
      },
      size: {
